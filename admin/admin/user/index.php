            ...
            <nav class="px-3 py-2 bg-white rounded shadow-sm">
                ...
                <div class="dropdown-menu fx-dropdown-menu">
                    <?php if ($code != '') : ?>
                        ...
                        <div class="list-group list-group-flush">
                            <a href="?users" class="list-group-item list-group-item-action d-flex justify-content-between align-items-start">
                                <div class="me-auto">
                ...
                <div class="dropdown">
                    <div class="d-flex align-items-center cursor-pointer dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <img class="navbar-profile-image" src="uploads/<?php echo $resul['profile'] ?>" alt="Image">
                    </div>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php if ($code != '') : ?>
                                                                <form action="" method="post">
                                                                    ...
                                                                    <button name="submit" class="btn btn-info btn-sm" type="submit"><i class="ri-mail-send-line "></i></button>
                                                                </form>

                                                            <?php endif ?>
                                                        </td>
                                                        <td><a href="#id_<?php echo $row['id']; ?>" class="btn btn-warning btn-sm" data-bs-toggle="modal"><i class="ri-camera-line "></i></a>
                                                        <td>
                                        ...
                                        <tbody class="data-list">
                                            ...
                                            ?>
                                                    <tr style="text-align: center;">
                                                        ...
                                                        <td><a href="#idadmin_<?php echo $row1['id']; ?>" class="btn btn-warning btn-sm" data-bs-toggle="modal"><i class="ri-camera-line "></i></a>
                                                        <td>
