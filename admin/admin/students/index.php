            ...
            <nav class="px-3 py-2 bg-white rounded shadow-sm">
                ...
                <div class="dropdown">
                    <div class="d-flex align-items-center cursor-pointer dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <img class="navbar-profile-image" src="../user/uploads/<?php echo $resul['profile'] ?>" alt="Image">
                    </div>
                                    ...
                                    ?>
                                        ...
                                        <div class=" mb-3 col-12 col-md-7 col-xl-2">
                                            <select name="course" id="course" class="form-control" required>
                                                ...
                                                <option value="<?php if (isset($_GET['course'])) {
                                                                    echo $_GET['course'];
                                                                } ?>"> Course: <?php if (isset($_GET['course'])) {
                                                                                                                                            echo $_GET['course'];
                                                                                                                                        } ?></option>
                                                <?php echo $course ?>
                                            </select>
                                        ...
                                        <div class=" mb-3 col-12 col-md-7 col-xl-2">
                                            <select name="year_name" id="year_name" class="form-control" required>
                                                ...
                                                <option value="<?php if (isset($_GET['year_name'])) {
                                                                    echo $_GET['year_name'];
                                                                } ?>"> Year: <?php if (isset($_GET['year_name'])) {
                                                                                                                                                echo $_GET['year_name'];
                                                                                                                                            } ?></option>
                                                <?php echo $year ?>
                                            </select>
                                        ...
                                        <div class=" mb-3 col-12 col-md-7 col-xl-2">
                                            <input type="text" name="section" required value="<?php if (isset($_GET['section'])) {
                                                                                                    echo $_GET['section'];
                                                                                                } ?>" class="form-control" placeholder="Input Section Here.">
                                        </div>
                                ...
                                ?>
                                    ...
                                    <div class=" mb-3 col-12 col-md-7 col-xl-3">
                                        <select name="academic" id="academic" class="form-control" required>
                                            ...
                                            <option value="<?php if (isset($_GET['academic'])) {
                                                                echo $_GET['academic'];
                                                            } ?>"> Academic: <?php if (isset($_GET['academic'])) {
                                                                                                                                            echo $_GET['academic'];
                                                                                                                                        } ?></option>
                                            <?php echo $academics ?>
                                        </select>
                                    ...
                                    <div class=" mb-3 col-12 col-md-7 col-xl-3" style="float: left; ">
                                        <select name="semester" id="semester" class="form-control" required>
                                            <option value="<?php if (isset($_GET['semester'])) {
                                                                echo $_GET['semester'];
                                                            } ?>"> Semester: <?php if (isset($_GET['semester'])) {
                                                                                                                                            echo $_GET['semester'];
                                                                                                                                        } ?></option>
                                            <?php echo $semesters ?>
                                        </select>
                            ...
                            <div class="card border-0 shadow-sm h-100">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive" style="text-align: center;">
                                        <h5>OFFICIAL LIST</h5>
                                        <h5><?php if (isset($_GET['semester'])) {
                                                echo $_GET['semester'];
                                            } ?></h5>
                                        <h6><?php if (isset($_GET['academic'])) {
                                                echo $_GET['academic'];
                                            } ?></h6>
