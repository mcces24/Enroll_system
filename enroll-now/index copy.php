...
<?php
   if($_SERVER["REQUEST_METHOD"] == "POST")if(isset($_POST["new"])){
     ...
     $home_zipcode = $_POST["home_zipcode"];
     ...
     $query = "SELECT * FROM students  WHERE semester_id != '$semester' AND academic != '$academic' AND fname = '$fname' AND mname = '$mname' AND lname = '$lname' AND date_of_birth = '$date_of_birth' AND (status_type = 'Enroll New Students' OR status_type = 'Enroll Old Students') ";
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST")if(isset($_POST["shift"])){
     ...
     if(mysqli_num_rows($query_run) > 0){
       foreach($query_run as $students){
        ...
        $query3 = "INSERT INTO shift_students VALUES('', '$id_number', '$course_id')";
...
<html lang="en-US">
   ...
   <body itemtype="https://schema.org/WebPage" itemscope="itemscope" class="page-template-default page page-id-640 wp-custom-logo exclusive-addons-elementor ast-single-post ast-inherit-site-logo-transparent ast-hfb-header ast-desktop ast-separate-container ast-two-container ast-no-sidebar astra-3.9.2 ast-normal-title-enabled elementor-default elementor-kit-5 elementor-page elementor-page-640">
    ...
    <?php
                                    ...
                                    <nav class="site-navigation ast-flex-grow-1 navigation-accessibility site-header-focus-item" id="primary-site-navigation" aria-label="Site Navigation" itemtype="https://schema.org/SiteNavigationElement" itemscope="itemscope">
                                       <div class="main-navigation ast-inline-flex">
                                          <ul id="ast-hf-menu-1" class="main-header-menu ast-menu-shadow ast-nav-menu ast-flex  submenu-with-border stack-on-mobile">
                                             <li id="menu-item-644" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-644"><a href="./../index.php" class="menu-link">Home</a></li>
                                             <li id="menu-item-645" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-645"><a href="./../academics/index.php" class="menu-link">Academics</a></li>
                                             <li id="menu-item-647" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-647"><a href="./../about/index.php" class="menu-link">About</a></li>
                                             <li id="menu-item-648" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-648"><a href="./../contact/index.php" class="menu-link">Contact</a></li>
                                             <li id="menu-item-649" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-640 current_page_item menu-item-649"><a href="index.php" aria-current="page" class="menu-link">Enroll Now</a></li>
                                             <li id="menu-item-650" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-650"><a href="../step/index.php" class="menu-link">Login</a></li>
                                          </ul>
                                       </div>
                                    </nav>
                                 </div>
         ...
         <div id="primary" class="content-area primary">
            <main id="main" class="site-main">
               <article class="post-640 page type-page status-publish ast-article-single" id="post-640" itemtype="https://schema.org/CreativeWork" itemscope="itemscope">
                  ...
                  <header class="entry-header ast-no-thumbnail ast-no-meta">
                     <h1 class="entry-title" itemprop="headline">Pre Enrollment is currently HAHA NOT AVAILABLE.</h1>
                  </header>
                  <!-- .entry-header -->
                  <?php endif; ?>
                                            ...
                                            <?php } elseif ($enrolls['enroll_name'] == 'Shift Students') {?>
                                             ...
                                             <div class="exad-advance-tab-content exad-tab-image-has-no  exad-tab-image-right">
                                                ...
                                                <div class=" happyforms-styles" id="happyforms-710">
                                                   ...
                                                   <div class="happyforms-part__el">
                                                   <div class="happyforms-input">
                                                   <input id="happyforms-710_single_line_text_11" type="email" name="email" value="" placeholder="Email" autocomplete="off" spellcheck="false" autocorrect="off" required>
                                                   </div>
                                                   </div>
                                                   </div>
                                                   </div>
                                                         ...
                                                         <div class="happyforms-flex">
                                                            ...
                                                            <div class="happyforms-form__part happyforms-part happyforms-part--single_line_text happyforms-part--width-third happyforms-part--label-show" id="happyforms-768_single_line_text_11-part" data-happyforms-type="single_line_text" data-happyforms-id="single_line_text_11" data-happyforms-required="">
                                                               <div class="happyforms-part-wrap">
                                                                  ...
                                                                  <div class="happyforms-part__el">
                                                                     <div class="happyforms-input">
                                                                        <input id="happyforms-768_single_line_text_11" type="email" name="email" value="" placeholder="Email" autocomplete="off" spellcheck="false" autocorrect="off" required>
                                                                     </div>
                                                                  </div>
                                                               </div>
                                                            </div>
      ...
      <script id="exad-main-script-js-extra">var exad_ajax_object = {"ajax_url":".\/wp-admin\/admin-ajax.php","nonce":"9a73e5aa45"};</script>
      ...
      <script id="wp-util-js-extra">var _wpUtilSettings = {"ajax":{"url":"\/mcc\/wp-admin\/admin-ajax.php"}};</script>
      ...
      <script id="happyforms-settings-js-extra">var _happyFormsSettings = {"ajaxUrl":".\/wp-admin\/admin-ajax.php"};</script>
