...
if (isset($_GET['applicant_id'])) {
  ...
  $query1 = "SELECT * FROM admission_list WHERE applicant_id='$applicant_id' ";
...
<head>
  ...
  <title>Admission Schedule &#8211; Madridejos Community College</title>
                                    ...
                                    <form action="<?php echo ($_SERVER["PHP_SELF"]); ?>" method="post" id="happyforms-form-710" autocomplete="off">
                                      ...
                                      <div class="happyforms-flex">
                                        ...
                                        <div class="happyforms-form__part happyforms-part happyforms-part--single_line_text happyforms-part--width-full happyforms-part--label-show" id="happyforms-710_single_line_text_14-part" data-happyforms-type="single_line_text" data-happyforms-id="single_line_text_14" data-happyforms-required="">
                                          <img src="mcc_header.png">
                                          <h4 style="text-align: center;">Date and Time Selection For Admission Test</h4>
                                          ...
                                          <div class="happyforms-part-wrap">
                                            ...
                                            <div class="happyforms-part__label-container">
                                              <label for="happyforms-710_single_line_text_3" class="happyforms-part__label">
                                                <span class="label">Select Date Of Your Choice: </span>
                                        ...
                                        <div class="happyforms-form__part happyforms-part happyforms-part--single_line_text happyforms-part--width-third happyforms-part--label-show" id="happyforms-710_single_line_text_3-part" data-happyforms-type="single_line_text" data-happyforms-id="single_line_text_3" data-happyforms-required="">
                                          <div class="happyforms-part-wrap">
                                            ...
                                            <div class="happyforms-part__label-container">
                                              <label for="happyforms-710_single_line_text_3" class="happyforms-part__label">
                                                <span class="label">Select Time Of Your Choice: </span>
                                                <span class="happyforms-required"></span>
                                              </label>
                                            </div>
                                            <div class="happyforms-part__el">
                                        ...
                                        <div class="happyforms-form__part happyforms-part happyforms-part--single_line_text happyforms-part--width-third happyforms-part--label-show" id="happyforms-710_single_line_text_3-part" data-happyforms-type="single_line_text" data-happyforms-id="single_line_text_3" data-happyforms-required="">
                                          <div class="happyforms-part-wrap">
                                            ...
                                            <div class="happyforms-part__label-container">
                                              <label for="happyforms-710_single_line_text_3" class="happyforms-part__label">
                                                <span class="label">Course to Enroll </span>
                                                <span class="happyforms-required"></span>
                                              </label>
                                            </div>
                                            <div class="happyforms-part__el">
                                              ...
                                              <div class="happyforms-custom-select">
                                                <div class="happyforms-part__select-wrap">
                                                  ...
                                                  <select name="wish_course" id="wish_course" data-serialize class="happyforms-select" onchange="FetchCourse(this.value)" required>
                                                    <option value="" class="happyforms-placeholder-option" selected disabled>Select Course</option>
                                                    <?php
                                                    if ($result->num_rows > 0) {
                                                      while ($row = $result->fetch_assoc()) {
                                        ...
                                        <div class="happyforms-form__part happyforms-part happyforms-part--submit">
                                          <button name="submit" type="submit" class="happyforms-submit happyforms-button--submit ">Submit</button>
                                        </div>
                                      </div>
  ...
  ?>
    <script>
      swal({
        ...
        text: "Please select other date and time.",
        icon: "<?php echo $_SESSION['icon1'] ?>",
        button: "Ok",
      });
    </script>
  <?php
