...
if(isset($_REQUEST["term"])){
    ...
    $sql = "SELECT * FROM students INNER JOIN que q ON students.id=q.student_id INNER JOIN admission_list a ON students.applicant_id = a.applicant_id WHERE semester_id = '$semester' AND academic = '$academic' AND status_type = 'Applicant' AND wish_course = 'BSHM' AND students.applicant_id LIKE ? LIMIT 5";
