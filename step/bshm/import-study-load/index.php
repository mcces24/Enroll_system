...
<head>
    ...
    <!-- end: CSS -->
    <title>Study Load | BSHM - Madridejos Community College</title>
                    ...
                    <div class="col-12 col-md-7 col-xl-8" style="width: 150%;">
                        <div class="card border-0 shadow-sm h-100">
                            ...
                            <div class="card-body">
                                         ...
                                         <div class="form-group">
                                            <input type="text" name="filter_course" id="filter_course" class="form-control" value="BS in Hospitality Management" readonly>
                                         </div>
                        ...
                        <table id="Mytableid" style="width: 100%; text-align: center;">
                            ...
                            <tbody>
                                ...
                                <?php  
                                    ...
                                    $query1 = "SELECT * FROM fees INNER JOIN course c ON fees.course_id=c.course_id INNER JOIN year_lvl y ON fees.year_id=y.year_id WHERE course_name = 'BS in Hospitality Management' ORDER BY year_name ";
