                        ...
                        <table >
                                ...
                                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM students INNER JOIN shift_students s ON students.id_number = s.id_number INNER JOIN course c ON students.course_id = c.course_id INNER JOIN year_lvl y ON students.year_id = y.year_id WHERE semester_id = '$semester' AND academic = '$academic' AND CONCAT(students.id_number) LIKE '%$filtervalues%' AND (status_type = 'Shift Students' OR status_type = 'Shift Clear' OR status_type = 'Shift Accept') AND course_code = 'BSHM'";
