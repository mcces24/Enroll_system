...
if(isset($_REQUEST["term"])){
    ...
    $sql = "SELECT * FROM students  INNER JOIN admission_list a ON students.applicant_id = a.applicant_id WHERE semester_id = '$semester' AND academic = '$academic' AND status_type = 'Applicant' AND wish_course = 'BEED' AND students.applicant_id LIKE ? LIMIT 5";
