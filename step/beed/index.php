                    ...
                    <div class="col-12 col-md-5 col-xl-6">
                        <div class="card border-0 shadow-sm h-100">
                            ...
                            <div class="card-body">
                                        ...
                                        $query = "SELECT * FROM que INNER JOIN admission_list a ON que.student_id = a.student_id WHERE wish_course = 'BEED' AND date_created = '$date_created' AND status = '0' ORDER BY id asc LIMIT 1  ";
