    ...
    if (empty($msg)) {
        if (mysqli_num_rows($result) === 1) {
            ...
            if (password_verify($password, $row['password'])) {
                ...
                // Check if the user role is "BEED Portal"
                if ($row['role'] == "BEED Portal") {
                    ...
                    logLoginAttempt($conn, $email, 'beed', 'success', $location, $completeAddress, $lat, $lon);
        ...
        logLoginAttempt($conn, $email, 'beed', 'failed', $location, $completeAddress, $lat, $lon);
    }
}
