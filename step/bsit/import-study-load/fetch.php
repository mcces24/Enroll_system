...
$query = "
SELECT * FROM subjects INNER JOIN course c ON subjects.course_id = c.course_id INNER JOIN year_lvl y ON subjects.year_id = y.year_id INNER JOIN sections ss ON subjects.section_id = ss.section_id WHERE course_name = 'BS in Information Technology'
";
