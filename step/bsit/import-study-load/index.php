...
<head>
    ...
    <!-- end: CSS -->
    <title>Study Load | BSIT - Madridejos Community College</title>
                        ...
                        <table id="Mytableid" style="width: 100%; text-align: center;">
                            ...
                            <tbody>
                                ...
                                <?php  
                                    ...
                                    $query1 = "SELECT * FROM fees INNER JOIN course c ON fees.course_id=c.course_id INNER JOIN year_lvl y ON fees.year_id=y.year_id WHERE course_name = 'BS in Information Technology' ORDER BY year_name ";
