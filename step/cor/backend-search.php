...
if(isset($_REQUEST["term"])){
    ...
    $academic = "$start-$end";
    $sql = "SELECT * FROM students  WHERE  (status_type = 'Enroll New Students' OR status_type = 'Enroll Old Students' OR status_type = 'Enroll ID') AND id_number LIKE ? AND semester_id = '$semester' AND academic = '$academic'  ORDER BY id_number DESC LIMIT 5";
