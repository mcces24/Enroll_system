...
<head>
    ...
    <!-- end: CSS -->
    <title>Old Students | ID Section - Madridejos Community College</title>
                        ...
                        <table >
                                ...
                                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM students INNER JOIN course c ON students.course_id = c.course_id INNER JOIN year_lvl y ON students.year_id = y.year_id INNER JOIN sections s ON students.section_id = s.section_id WHERE academic = '$academic' AND semester_id = '$semester' AND  status_type = 'Enroll Old Students'  AND CONCAT(id_number) LIKE '%$filtervalues%' ";
                                        $query_run = mysqli_query($conn, $query);
                            ...
                            if(mysqli_num_rows($query_run1) > 0)
                            {
                              ...
                              ?>
                                                ...
                                                <div style="float: left;" class="col-4 col-md-4 col-xl-4">
                                                     ...
                                                     <a href="#id_<?php $student['id']; ?>" class="btn btn-warning btn-sm" data-bs-toggle="modal"> Upload Image</a>
                                                     <?php endif; ?>
                                                        <?php endif; ?>
                                                    </p>
                                                    </div>
                                                ...
                                                <td width="100%"> 
                                                    ...
                                                    <?php if($code == 1): ?>
                                                        <a href="print_temp_id/temp_id.php?id=<?= $student['id']; ?>"  data-toggle="modal "  target="_blank" class="btn btn-sm btn-success" >Print Temporary ID</a>
                                                     <a href="print_id/id.php?id_number=<?= $student['id_number']; ?>"  data-toggle="modal "  target="_blank" class="btn btn-sm btn-warning" >Print School ID</a>
                                                     <a href="#id_<?php $student['id']; ?>" class="btn btn-warning btn-sm" data-bs-toggle="modal"> Update Image</a>
                                                     <?php endif; ?>
                                                    </td>
