...
<div class="modal fade" id="id_<?php  $student['id']; ?>" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align: left;">
            <div class="">
                 <form action="edit_PDO.php<?php echo '?id='.$id_number; ?>" method="POST" enctype="multipart/form-data">
