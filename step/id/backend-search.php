...
if(isset($_REQUEST["term"])){
    ...
    $academic = "$start-$end";
    $sql = "SELECT * FROM students  WHERE  (status_type = 'New Students' OR status_type = 'Enroll New Students')  AND id_number LIKE ? AND semester_id = '$semester' AND academic = '$academic' LIMIT 5";
