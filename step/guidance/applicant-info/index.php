    ...
    <main class="bg-light">
        <div class="p-2">
            ...
            <nav class="px-3 py-2 bg-white rounded shadow-sm">
                ...
                <h5 class="fw-bold mb-0 me-auto">Applicant Info </h5>
                                    ...
                                    <div class="table-responsive">
                                        <table id="Mytableid">
                                            ...
                                            <tbody>
                                                ...
                                                $query1 = "SELECT * FROM students where status_type='Form Done' AND academic = '$academic' AND semester_id = '$semester'";
                            ...
                            <input type="checkbox" onclick="return myfun()" id="' . $student["id"] . '" name="single_select" class="single_select" data-email="' . $student["email"] . '" data-name="' . $student["id"] . '" />
                                                    ...
                                                    ';
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="button" name="email_button" class="btn btn-info btn-sm email_button" id="' . $count . '" data-email="' . $student["email"] . '" data-name="' . $student["id"] . '" data-app="' . $student["id"] . '" data-action="single">Send Admission</button>
