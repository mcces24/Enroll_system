...
$data = applicantAdmissionFunction();
$applicantAdmissionData = isset($data['applicantAdmissionData']) ? $data['applicantAdmissionData'] : [];

// print_r($applicantAdmissionData);
?>
                                ...
                                <?php if (!empty($academic) && !empty($semester)) : ?>
                                    <div class="table-responsive">
                                        <table id="Mytableid">
                                            ...
                                            <tbody>
                                                <?php
                                                if (!empty($applicantAdmissionData)) {
                                                    foreach ($applicantAdmissionData as $applicant) {
                                                ?>
