...
if (isset($_POST['push_notification'])) {
	...
	if (mysqli_num_rows($res) > 0) {
		...
		$body = '<h4>Madridejos Community College check your Admission Test</h4>
				...
				<a href="https://madridejoscommunitycollege.com/assestment.php?applicant_id='.$id.'">https://madridejoscommunitycollege.com/assestment.php?applicant_id='.$id.'</a>
				<br>
				<p>Please print this form:</p>
				<a href="https://madridejoscommunitycollege.com/enrollment-step.php?applicant_id='.$id.'">https://madridejoscommunitycollege.com/enrollment-step.php?applicant_id='.$id.'</a>
				<br>
