...
<head>
    ...
    <!-- end: CSS -->
    <title>Admission Schedule - Guidance Office</title>
   ...
   <link rel="stylesheet" type="text/css" href="../../../loader/styles.css" />
    ...
    <main class="bg-light">
        ...
        ?>
                      ...
                      <option  value="<?php if(isset($_GET['sched_date'])){echo $_GET['sched_date']; } ?>" selected ><?php if(isset($_GET['sched_date'])){echo $_GET['sched_date']; } else{ ?>Select Date <?php }?></option>  
                      <?php
                    if ($result->num_rows > 0 ) {
                       while ($row = $result->fetch_assoc()) {
        ...
        ?>
                      ...
                      <option  value="<?php if(isset($_GET['sched_time'])){echo $_GET['sched_time']; } ?>" selected ><?php if(isset($_GET['sched_time'])){echo $_GET['sched_time']; } else{ ?>Select Time <?php }?></option>     
                      <?php
                    if ($result->num_rows > 0 ) {
                       while ($row = $result->fetch_assoc()) {
