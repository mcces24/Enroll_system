    <div class="modal fade" id="update_<?php $row['id']; ?>" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: left;">
                    <form method="POST" action="update.php?id=<?php $row['id']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="" id="" class="form-control" value="<?php echo $row['lname']; ?>, <?php echo $row['fname']; ?> <?php echo $row['mname']; ?>" readonly>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="edit" class="btn btn-primary"> Enroll</a>
                        </form>
                </div>
            </div>
        </div>
