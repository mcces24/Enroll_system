                        ...
                        <div class="card border-0">
                            ...
                            <div class="card-body">
                                ...
                                if(isset($_GET['sched_date']) AND isset($_GET['sched_time'])){
                                    ...
                                    $query = "SELECT * FROM admission_list  INNER JOIN students b ON admission_list.applicant_id = b.applicant_id WHERE sched_date = '$sched_date' AND sched_time = '$sched_time' AND semester_id = '$semester' AND academic = '$academic'  ORDER BY admission_list.applicant_id ASC ";
