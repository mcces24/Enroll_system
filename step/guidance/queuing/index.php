                            ...
                            <div class="card-body searches">
                                ...
                                <form action="" method="GET">
                                    <div class="input-group mb-3 search-box1">
                                        <input  type="text" autocomplete="off" name="search_students" required value="<?php if(isset($_GET['search_students'])){echo $_GET['search_students']; } ?>" class="form-control" placeholder="Search id number...">
...
$(document).ready(function(){
    $('.search-box1 input[type="text"]').on("keyup input", function(){
        ...
        if(inputVal.length){
            $.get("backend-search-students.php", {term1: inputVal}).done(function(data){
                // Display the returned data in browser
                resultDropdown.html(data);
            });
        } else{
