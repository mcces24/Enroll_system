...
<head>
    ...
    <!-- end: CSS -->
    <title>Failed to passed - Guidance Office</title>
    ...
    <main class="bg-light">
        <div class="p-2">
            ...
            <nav class="px-3 py-2 bg-white rounded shadow-sm">
                ...
                <h5 class="fw-bold mb-0 me-auto">Applicant | Failed to passed   </h5>
                    ...
                    <div class="col-12 col-md-7 col-xl-8" style="width: 100%;">
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-header bg-white">
                                List of of applicant who are not able to passed the admission
                        </div>
                            <div class="card-body">
                                <?php if(in_array($rows['status'] AND $rows1['sem_status'],array('1'))): ?> 
                        ...
                        <table id="Mytableid">
                            ...
                            <tbody>
                                <?php  
                                    ...
                                    $query1 = "SELECT * FROM students INNER JOIN admission_score a on students.applicant_id = a.applicant_id WHERE total_cat='Low Average' AND academic = '$academic' AND semester_id = '$semester'";
