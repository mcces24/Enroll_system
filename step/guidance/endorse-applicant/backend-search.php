...
if(isset($_REQUEST["term"])){
    ...
    $academic = "$start-$end";
    $sql = "SELECT * FROM students INNER JOIN admission_score a ON students.applicant_id=a.applicant_id  WHERE semester_id = '$semester' AND academic = '$academic' AND (status_type = 'Applicant' or status_type = 'Accept' or status_type = 'Enroll New Students') AND students.applicant_id LIKE ? LIMIT 5";
