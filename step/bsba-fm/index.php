  ...
  $username = $_SESSION['SESSION_BSBA'];
}
?>
<?php
  include_once '../../database/config.php';
  include_once '../../database/config2.php';
  $query = "SELECT * FROM course where course_name ='BS in Business Administration Financial Management'";
...
<head>
    ...
    <!-- end: CSS -->
    <title>BSBA Portal - Madridejos Community College</title>
...
<?php
    ...
    <div class="sidebar position-fixed top-0 bottom-0 bg-white border-end">
        <div class="d-flex align-items-center p-3">
            ...
            <a href="index.php" class="sidebar-logo text-uppercase fw-bold text-decoration-none text-indigo fs-4">BSBA | Portal</a>
        ...
        <?php 
            $username = $_SESSION['SESSION_BSBA'];
            $sel = "SELECT * FROM users WHERE role='BSBA Portal' AND online = '1' AND username='$username'";
    ...
    <main class="bg-light">
                    ...
                    <div class="col-12 col-md-5 col-xl-6">
                        <div class="card border-0 shadow-sm h-100">
                            ...
                            <div class="card-body">
                                        ...
                                        $query = "SELECT * FROM que INNER JOIN admission_list a ON que.student_id = a.student_id WHERE wish_course = 'BSBA' AND date_created = '$date_created' AND status = '0' ORDER BY id asc LIMIT 1  ";
        ...
        <textarea hidden  id="content"> Attention priority number <?= $student['que_number']; ?>. Please proceed to BSBA Department Office. Attention priority number <?= $student['que_number']; ?>. Please proceed to BSBA Department Office. Thank you!</textarea>
