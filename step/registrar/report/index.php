   ...
   <link rel="stylesheet" type="text/css" href="../../../loader/styles.css" />
                        ...
                        <table id="Mytableid">
                            ...
                            <tbody>
                                <?php  
                                    ...
                                    $query1 = "SELECT * FROM students INNER JOIN course ON students.course_id=course.course_id INNER JOIN year_lvl ON students.year_id=year_lvl.year_id where (status_type='Enroll Old Students' OR status_type='Enroll New Students') AND academic = '$academic' AND semester_id = '$semester' ORDER BY id ASC";
    ...
    $('#Mytableid').DataTable( {
        ...
        buttons: [
            ...
            { extend: 'copy', className: 'bg-success' },
            { extend: 'csv', className: 'bg-primary' },
            { extend: 'excel', className: 'bg-primary' },
            { extend: 'pdf', className: 'bg-primary' },
            { extend: 'print', className: 'bg-secondary' },
        ]
    }
    } );
} );
