...
<?php
                    ...
                    <?php
                                    ...
                                    $academic = "$start-$end";
                        $sql="SELECT * from students  INNER JOIN year_lvl y On students.year_id=y.year_id INNER JOIN course c ON students.course_id=c.course_id WHERE semester_id = '$semester' AND academic = '$academic' AND  status_type = 'Old Students'";
                        $result=$conn-> query($sql);
                        $old_students=0;
                        if ($result-> num_rows > 0){
                            while ($row=$result-> fetch_assoc()) {
