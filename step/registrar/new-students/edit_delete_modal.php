        ...
        <form method="POST" action="code.php">
            ...
            <div class="form-group">
                            ...
                            <input type="text" name="course" id="course" class="form-control"
                                value="<?php echo $student['course_name']; ?>" readonly>
                                
                        </div>
            <div class="form-group">
                            <label class="form-group"> Year Level </label>
                            <input type="text" name="" id="" class="form-control"
                                value="<?php echo $student['year_name']; ?>" readonly>
                            <input type="hidden" name="year_id" id="year_id" class="form-control"
                                value="<?php echo $student['year_id']; ?>" >
                        </div>
            <div class="form-group">
                <label>Name of Section | ex: N or A</label>
                <input type="" name="sections" id="sections" class="form-control"
                               placeholder="Enter New Section" required>
            </div>
            <div class="form-group">
                <label>Section Code | ex: BSIT 1 N</label>
                <input type="" name="section_code" id="section_code" class="form-control"
                               placeholder="Enter Section Code" required>
            </div>
        ...
        <form method="POST" action="code.php">
            ...
            <div class="form-group">
                            ...
                            <input type="text" name="applicant_id" id="applicant_id" class="form-control"
                                value="<?php echo $student['applicant_id']; ?>" readonly>
    ...
    <?php
                    ...
                    ?> 
                        ...
                        <div class="form-group">
                            ...
                            <input style="color: red;" type="text" name="id_number" id="id_number" class="form-control"
                                value="No Ongoing Academic Year"  readonly>
                                <?php endif; ?>
                        </div>
