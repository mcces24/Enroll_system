...
<head>
    ...
    <!-- end: CSS -->
    <title>Account | Registrar Office</title>
                                                ...
                                                <tr>
                                                        ...
                                                        <div class="form-group" >
                                                            ...
                                                            <input type="text" name="email_user" id="email_user" class="form-control"
                                                                placeholder="Enter Findings" value="<?= $student['email_user']; ?>">
                                                        </div>
                                                        ...
                                                        <div class="form-group" >
                                                            ...
                                                            <input type="text" name="email_pass" id="email_pass" class="form-control"
                                                                placeholder="Enter Findings" value="<?= $student['email_pass']; ?>">
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="email_name" id="email_name" class="form-control"
                                                                placeholder="Enter Findings" value="<?= $student['email_name']; ?>">
                                                        </div>
                                                </tr>
