...
<head>
    ...
    <!-- end: CSS -->
    <title>Verify Subjects | Registrar Office - Madridejos Community College</title>
    ...
    <main class="bg-light">
        <div class="p-2">
            ...
            <nav class="px-3 py-2 bg-white rounded shadow-sm">
                ...
                <h5 class="fw-bold mb-0 me-auto">Verify Subjects</h5>
                ...
                <div class="row g-3 mt-2">
                    ...
                    <div class="card border-0 shadow-sm h-100">
                            <div class="card-header bg-white">
                                ...
                                <a style="margin-right: 20px" href="enrollment_form_irregular.php?id_number=<?php echo $_GET['id_number'] ?>" class="btn btn-primary btn-sm float-end" target="_blank">Print Enrollment Form</a>
                           
                            </div>

                            <div class="card-body">
                                <?php if(in_array($rows11['status'] AND $rows111['sem_status'],array('1'))): ?> 
                        ...
                        <table id="Mytableid">
                            ...
                            <tbody>
                                <?php  
                                    ...
                                    $query1 = "SELECT * FROM selected_subject INNER JOIN subjects a ON selected_subject.subject_id=a.subject_id WHERE id_number = '$id_number' ORDER BY selected_subject.subject_id ASC";
                                                ...
                                                <td>
                                                    ...
                                                    <?php
                                                            ...
                                                            echo '
                                                                ...
                                                                <button type="button" name="email_button" class="btn btn-info btn-sm email_button" id="'.$count.'" data-email="'.$id_number.'" data-name="'.$student["subject_id"].'" data-app="'.$student["subject_id"].'" data-action="single">Remove</button>
                    ...
                    <?php endif; ?>
<?php if(in_array($rows11['status'] AND $rows111['sem_status'],array('0'))): ?>
