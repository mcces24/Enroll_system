                                        ...
                                        if(mysqli_num_rows($query_run) > 0)
                                        {
                                            ...
                                            <div class="input-group mb-3">
                                                <div style="float: left;" class="col-4 col-md-4 col-xl-4">
                                                        ...
                                                        <p style="width: 90%;" class="form-control"><?php echo $row['course_name'] ?></p>
                                                    </div>
                                                    <div style="float: left;" class="col-4 col-md-4 col-xl-4">
                                                        <label class="mb-1"><span>Year Level</span></label>
                                                        <p style="width: 90%;" class="form-control"><?php echo $row['year_name'] ?></p>
                                                    </div>
                                                    <div style="float: left;" class="col-4 col-md-4 col-xl-4">
                                                        <label class="mb-1"><span>Section</span></label>
                                                        <?php if ($row['section_id'] !=0) {?>
                                                           <p style="width: 90%; color: red;" class="form-control"><?php echo $row['sections'] ?></p> 
                                                       <?php } else{?>
                                            ...
                                            <div class="input-group mb-3">
                                                <div style="float: left;" class="col-4 col-md-4 col-xl-4">
                                                        ...
                                                        <p style="width: 90%;" class="form-control"><?php echo $row['fname'] ?></p>
                                                    </div>
                                                    <div style="float: left;" class="col-4 col-md-4 col-xl-4">
                                                        <label class="mb-1"><span>Middle Name</span></label>
                                                        <p style="width: 90%;" class="form-control"><?php echo $row['mname'] ?></p>
                                                    </div>
                                                    <div style="float: left;" class="col-4 col-md-4 col-xl-4">
                                                        <label class="mb-1"><span>Last Name</span></label>
                                                        <p style="width: 90%;" class="form-control"><?php echo $row['lname'] ?></p>
                                                    </div>
                                                </div>
                                                <div class="input-group mb-3">
                                                <div style="float: left;" class="col-4 col-md-4 col-xl-4">
                                                        <label class="mb-1"><span>Address</span></label>
                                                        <p style="width: 90%;" class="form-control"><?php echo $row['address'] ?></p>
                                                    </div>
                                                    <div style="float: left;" class="col-4 col-md-4 col-xl-4">
                                                        <label class="mb-1"><span>Gender</span></label>
                                                        <p style="width: 90%;" class="form-control"><?php echo $row['gender'] ?></p>
                                                    </div>
                                                    <div style="float: left;" class="col-4 col-md-4 col-xl-4">
                                                        <label class="mb-1"><span>ID Number</span></label>
                                                        <p style="width: 90%; color: red;" class="form-control"><?php echo $row['id_number'] ?></p>
                                                    </div>
                                                </div>
                                                ...
                                                <td width="100%"> 
                                                     ...
                                                     <a href="#edit_<?= $row['id']; ?>" class="btn btn-success btn-sm" data-bs-toggle="modal"> Enroll | Accept Students</a>
                                                     <?php endif; ?>
                                                     <?php if(in_array($row['status_type'],array('Old Students')) AND in_array($row['type'],array('Irregular'))): ?>
                                                     <a href="#edit_<?= $row['id']; ?>" class="btn btn-success btn-sm" data-bs-toggle="modal"> Enroll | Accept Students</a>
                                                     <?php endif; ?>

                                                     <?php if(in_array($row['status_type'],array('Enroll Old Students')) AND in_array($row['type'],array('Regular'))): ?>
                                                     <a href="enrollment_form.php?id=<?= $row['id_number']; ?>" class="btn btn-primary btn-sm" target="_blank">Generate Enrollment Form</a>
                                                     <?php endif; ?>
                                                     <?php if(in_array($row['status_type'],array('Enroll Old Students')) AND in_array($row['type'],array('Irregular'))): ?>
                                                     <a href="subject-select.php?id_number=<?= $row['id_number']; ?>&section=<?= $row['section_id']; ?>" class="btn btn-primary btn-sm" target="_blank">Subjects To Enroll</a>
                                                     <?php endif; ?>
