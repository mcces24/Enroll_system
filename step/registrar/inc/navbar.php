...
?>
<style>
    .sidebar-menu-item.has-dropdown.focused .sidebar-dropdown-menu {
...
<div class="sidebar position-fixed top-0 bottom-0 bg-white border-end">
    <div class="d-flex align-items-center p-3">
        ...
        <a href="index.php" class="sidebar-logo text-uppercase fw-bold text-decoration-none text-indigo fs-4">Registrar Office </a>
    ...
    <ul class="sidebar-menu p-3 m-0 mb-0">
        ...
        <li class="sidebar-menu-item has-dropdown <?php echo isFocused('/account/index'); ?> <?php echo isFocused('/enrollment-schedule/index'); ?>">
            <a href="#">
