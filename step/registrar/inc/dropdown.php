...
$sql_new="SELECT COUNT(*) as new_students from students INNER JOIN que ON students.id = que.student_id INNER JOIN year_lvl y On students.year_id=y.year_id INNER JOIN course c ON students.course_id=c.course_id WHERE que.date_created = $currentDate AND semester_id = '$semester' AND academic = '$academic' AND  status_type = 'Enroll'";
