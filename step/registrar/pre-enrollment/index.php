    ...
    <main class="bg-light">
        <div class="p-2">
            ...
            <nav class="px-3 py-2 bg-white rounded shadow-sm">
                ...
                <h5 class="fw-bold mb-0 me-auto">Pre Enrollment Old</h5>
                        ...
                        <table id="Mytableid">
                            ...
                            <tbody>
                                <?php  
                                    ...
                                    $query1 = "SELECT * FROM students INNER JOIN course ON students.course_id=course.course_id INNER JOIN year_lvl ON students.year_id=year_lvl.year_id where status_type='Pre Old Students' AND academic = '$academic' AND semester_id = '$semester' ORDER BY id ASC";
