...
<head>
    ...
    <title>Shift Students | Registrar Office - Madridejos Community College</title>
                    ...
                    <div class="card border-0 shadow-sm h-100">
                            ...
                            <div class="card-body" style="width: 50%;">
                                    <form action="" method="GET">
                                        ...
                                        <input  type="text" autocomplete="off" name="search" required value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>" class="form-control" placeholder="Input Applicant Number here!">
                    ...
                    if(isset($_GET['search']))
                        ...
                        <table >
                                ...
                                <?php 
                                        ...
                                        $query = "SELECT * FROM students INNER JOIN course c ON students.course_id = c.course_id INNER JOIN year_lvl y ON students.year_id=y.year_id WHERE (status_type = 'Enroll Old Students' OR status_type = 'Shift Accept') AND semester_id = '$semester' AND academic = '$academic' AND CONCAT(id_number) LIKE '%$filtervalues%'";
                                        $query_run = mysqli_query($conn, $query);
                                        ...
                                        $query = "SELECT * FROM students INNER JOIN course c ON students.course_id = c.course_id INNER JOIN year_lvl y ON students.year_id=y.year_id  INNER JOIN sections s ON students.section_id=s.section_id WHERE (status_type = 'Enroll Old Students' OR status_type = 'Shift Clear') AND semester_id = '$semester' AND academic = '$academic' AND CONCAT(id_number) LIKE '%$filtervalues%'";
                                        }
                                        $query_run = mysqli_query($conn, $query);
                                        ...
                                        if(mysqli_num_rows($query_run) > 0)
                                        {
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="input-group mb-3">
                                                <div style="float: left;" class="col-4 col-md-4 col-xl-4">
                                                        <label class="mb-1"><span>Status</span></label>
                                                        <p style="width: 90%;" class="form-control"><?php echo $student['status_type'] ?></p>
                                                    </div>
                                                    <div style="float: left;" class="col-4 col-md-4 col-xl-4">
                                                ...
                                                <td width="100%"> 
                                                     ...
                                                     <?php if(in_array($student['status_type'],array('Shift Accept'))): ?>
                                                     <a href="#edit_<?php echo $student['id']; ?>" class="btn btn-info btn-sm" data-bs-toggle="modal"> Enroll Student</a>
                                                      <?php endif; ?>
                                                     <?php if(in_array($student['status_type'],array('Enroll Old Students'))): ?>
